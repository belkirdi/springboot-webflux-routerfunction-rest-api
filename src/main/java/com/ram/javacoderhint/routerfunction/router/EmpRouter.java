...
public class EmpRouter {
    ...
    public RouterFunction<ServerResponse> route() {
        return RouterFunctions
                ...
                .andRoute(PUT("/employees").and(accept(APPLICATION_JSON)), empHandler :: createEmp)
                .andRoute(DELETE("/employees/{id}").and(accept(APPLICATION_JSON)), empHandler :: deleteEmp)
                .andRoute(GET("/employees/events/stream").and(accept(APPLICATION_JSON)), empHandler :: streamEmp);
